...
class restofthecourseScreen extends StatefulWidget {
  final String courseName;
  final bool canEdit;
  const restofthecourseScreen({
    super.key,
  ...
  @override
  State<restofthecourseScreen> createState() => _restofthecourseScreenState();
}

class _restofthecourseScreenState extends State<restofthecourseScreen> {
